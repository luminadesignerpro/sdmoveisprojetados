...
class ARStudioWidgetState extends State<ARStudioWidget> {
  ...
  final List<Map<String, dynamic>> wallColors = [
    {"name": "Branco TX", "uri": "https://modelviewer.dev/shared-assets/models/glTF-Sample-Models/2.0/Box/glTF-Binary/Box.glb", "price": 100.0, "color": Colors.white},
    {"name": "Freijó Ouro", "uri": "https://modelviewer.dev/shared-assets/models/glTF-Sample-Models/2.0/Box/glTF-Binary/Box.glb", "price": 180.0, "color": Colors.brown},
    {"name": "Grafite Premium", "uri": "https://modelviewer.dev/shared-assets/models/glTF-Sample-Models/2.0/Box/glTF-Binary/Box.glb", "price": 150.0, "color": Colors.blueGrey},
  ];
...
""";
  ...
  Future<void> _handleMeasureMode(math.Matrix4 pose) async {
    ...
    var newNode = ARNode(
      ...
      uri: "https://modelviewer.dev/shared-assets/models/glTF-Sample-Models/2.0/Sphere/glTF-Binary/Sphere.glb", 
